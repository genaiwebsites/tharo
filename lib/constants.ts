...
export const FITTING_STAGES: FittingStage[] = [
  {
    n: '01',
    name: 'Consultation',
    piece: 'Collar stand & Stance',
    duration: 'Day 01 · 45 mins',
    metric: '5 Events',
    metricLabel: 'Wardrobe Sequence Calibrated',
  ...
  {
    n: '02',
    name: 'Fabric Curation',
    piece: 'Cuff & Texture Swatch',
    duration: 'Day 03 · Mill Selection',
    metric: '320 GSM',
    metricLabel: 'Varanasi Raw Silk & Biella Wool',
  ...
  {
    n: '03',
    name: '42 Measurements',
    piece: 'Sleeve & Shoulder Slope',
    duration: 'Day 05 · Master Drafting',
    metric: '42 Points',
    metricLabel: 'Anatomical Posture & Slope Scanned',
    note: 'A full set of 42 anatomical measurements is recorded on parchment. Posture delta is drafted, not only circumference.',
  ...
  {
    n: '04',
    name: 'Basting First Fit',
    piece: 'Back Yoke & Canvas Body',
    duration: 'Day 14 · Atelier Fitting',
    metric: '0.25" Tolerance',
    metricLabel: 'Chalk Alterations on Raw Canvas',
    note: 'The garment comes back inside-out with white basting thread. This is where it is tested on the body so drape can be sculpted.',
  ...
  {
    n: '05',
    name: 'Final Hand Press',
    piece: 'Assembled Bespoke Garment',
    duration: 'Day 21 · Delivery',
    metric: '100% Bespoke',
    metricLabel: 'Hand-Cut, Pressed & Bagged',
    note: 'Final fitting at 31 Allenby Road, then pressed with bespoke wooden forms and bagged. If the fit has not landed, it goes back.',
